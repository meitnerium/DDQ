...
!
!       Perform one-dimensional multiple row transform inplace.
!       Note that row data are not unit-stride.
!
!*******************************************************************************
...
!
      ...
      if(LEGEND_PRINT) then
          print*, 'COMPLEX_1D_DOUBLE_EX3'
          print*, 'Forward-Backward 1D complex transform for double precision data'
          print*, 'Perform one-dimensional multiple row transform inplace'
          print *
