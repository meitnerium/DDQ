...
!
!       Backward 1D complex transform for double precision data not inplace
...
!*******************************************************************************
      ...
      Program COMPLEX_1D_DOUBLE_EX10
...
!
      call INIT_BACKW_TONE_AND_EXP_RES_Z(X_IN, X_EXP, n)
