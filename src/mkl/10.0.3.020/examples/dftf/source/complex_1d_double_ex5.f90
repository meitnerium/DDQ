...
!       which are allocated in two-dimension array.
!
!       Perform one-dimensional multiple columns transform inplace.
!       Note that column data are unit-stride.
!
!*******************************************************************************
...
!
      ...
      if(LEGEND_PRINT) then
          print*, 'COMPLEX_1D_DOUBLE_EX5'
          print*, 'Forward-Backward 1D complex transform for double precision data'
          print*, 'Perform one-dimensional multiple columns transform inplace.'
          print *
