...
!
!       Forward 1D complex transform for double precision data inplace
...
!           DFTI_FORWARD_SCALE  = 1.0/real(n)           (default=1.0)
!
...
!
      ...
      if(LEGEND_PRINT) then
          ...
          print *, 'DFTI_FORWARD_SCALE  = 1.0/real(n) '
          print *
      endif
